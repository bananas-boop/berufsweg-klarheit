  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div
        ...
        style={{ background: "linear-gradient(to right, hsl(30 10% 22% / 0.35) 0%, hsl(30 10% 22% / 0.1) 60%, transparent 100%)" }}
      />
      <div className="relative z-10 flex flex-col justify-end h-full max-w-6xl mx-auto px-6 md:px-12 pb-24 md:pb-32">
        <div className="max-w-2xl">
          ...
          <p className="text-hero/80 text-base md:text-lg font-light leading-relaxed mb-10 max-w-xl fade-in-delay-1">
            Für Fach- und Führungskräfte, die beruflich weiterkommen wollen und Orientierung für ihren nächsten Schritt suchen.
          </p>
          <button
            onClick={scrollToContent}
            className="text-hero border border-hero/40 px-8 py-3 text-sm font-light tracking-widest uppercase hover:bg-hero/10 transition-all duration-300 fade-in-delay-2"
          >
            Mehr erfahren
          </button>
        </div>
